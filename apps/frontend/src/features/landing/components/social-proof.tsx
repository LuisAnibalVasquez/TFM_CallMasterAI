...
export function SocialProof() {
  return (
    <section
      id="trust"
      className="relative border-t border-border bg-background py-20 sm:py-24"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-base text-muted-foreground sm:text-lg">
            ...
            <span className="text-foreground"> Call Master AI</span>.
          </p>
        </div>
        ...
        <ul
          ...
          className="mt-10 grid grid-cols-2 items-center gap-4 sm:grid-cols-3 lg:grid-cols-6"
        >
          {LOGOS.map((name) => (
            <li
              key={name}
              className="flex items-center justify-center rounded-xl border border-border bg-card px-4 py-5 transition-colors hover:bg-secondary"
            >
        ...
        <div className="mt-12 grid items-stretch gap-4 lg:grid-cols-5">
          <div className="flex items-center gap-4 rounded-2xl border border-border bg-card p-6 shadow-sm lg:col-span-2">
          ...
          <figure className="rounded-2xl border border-border bg-card p-6 shadow-sm lg:col-span-3">
