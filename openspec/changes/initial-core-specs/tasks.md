...
- [x] 2.3 Implementar `SupabaseAuthService` en `apps/backend/src/modules/auth/infrastructure/providers`.
- [x] 2.4 Configurar Swagger en `apps/backend/src/main.ts` para documentar la API.
